<div class="container">
    <div class="newsletter-template">
        <div class="news-icon">
            <img src="./img/tna-newsletter-icon.png" alt="The National Archives Newsletter Icon">
        </div>
        ...
        <div class="news-form">
            <form name="signup" id="signup" action="https://r1-t.trackedlink.net/signup.ashx" method="post" role="form">
                ...
                <input type="hidden" name="ReturnURL" value="http://www.nationalarchives.gov.uk/about/get-involved/newsletters/the-national-archives-newsletter/thank-you/?oldurl=http://www.nationalarchives.gov.uk/education/sessions-and-resources/?time-period=empire-and-industry">
