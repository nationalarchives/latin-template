<article>
    ...
    <div class="entry-content">
        ...
        <ul>
            <li>
                <h3 id="abbot">Abbot</h3>
                <hr>
                <p>Monk in charge of an abbey.</p>
            </li>
            <li>
                <h3 id="ablative">Ablative</h3>
                <hr>
            ...
            <li>
                <h3 id="accusative">Accusative</h3>
                <hr>
            ...
            <li>
                <h3 id="all saints">All Saints</h3>
                <hr>
            ...
            <li>
                <h3 id="annunciation">Annunciation</h3>
                <hr>
            ...
            <li>
                <h3 id="answer for">Answer for</h3>
                <hr>
                <p>To be liable for.</p>
            </li>
            <li>
                <h3 id="appurtenance">Appurtenance</h3>
                <hr>
            ...
            <li>
                <h3 id="archangel">Archangel</h3>
                <hr>
                <p>The highest rank of angel.</p>
            </li>
            <li>
                <h3 id="assize">Assize</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="beasts of the chase">Beasts of the chase</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="cleric, clerk">Cleric, clerk</h3>
                <hr>
            ...
            <li>
                <h3 id="conquest, norman conquest">Conquest, Norman Conquest</h3>
                <hr>
            ...
            <li>
                <h3 id="court of common pleas">Court of Common Pleas</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="declension">Declension</h3>
                <hr>
            ...
            <li>
                <h3 id="demonstrative pronoun">Demonstrative pronoun</h3>
                <hr>
                <p>hic, hec, hoc and is, ea, id are demonstrative pronouns.</p>
            </li>
            <li>
                <h3 id="denizenship">Denizenship</h3>
                <hr>
            ...
            <li>
                <h3 id="domesday book">Domesday Book</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="edward the confessor, king edward">Edward the Confessor, King Edward</h3>
                <hr>
            ...
            <li>
                <h3 id="edward the martyr">Edward the Martyr</h3>
                <hr>
            ...
            <li>
                <h3 id="elizabeth I">Elizabeth I</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                ...
                <hr>
                <p>One of the three genders of nouns. Nouns relating to women and to female names are usually feminine, such as domina (lady), filia (daughter) and Maria (Mary). Many other nouns are also feminine, including terra (land) and ecclesia (church).</p>
            </li>
            <li>
                <h3 id="final concord">Final concord</h3>
                <hr>
            ...
            <li>
                <h3 id="first declension">First declension</h3>
                <hr>
            ...
            <li>
                <h3 id="frankpledge, view of frankpledge">Frankpledge, view of frankpledge</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="hemingbrough">Hemingbrough</h3>
                <hr>
                <p>Settlement in Yorkshire.</p>
            </li>
            <li>
                <h3 id="henry I">Henry I</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="infinitiver">Infinitiver</h3>
                <hr>
            ...
            <li>
                <h3 id="inquisition">Inquisition</h3>
                <hr>
                <p>Formal process of research and examination into an issue.</p>
            </li>
            <li>
                <h3 id="inspeximus">Inspeximus</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="justice of the peace">Justice of the peace</h3>
                <hr>
        ...
        <ul>
            <li>
                <h3 id="key letter">Key letter</h3>
                <hr>
        ...
        <ul>
            <li>
                <h3 id="magna carta">Magna Carta</h3>
                <hr>
            ...
            <li>
                <h3 id="manumission">Manumission</h3>
                <hr>
            ...
            <li>
                ...
                <hr>
                <p>One of the three genders of nouns. Nouns relating to men and male names are generally masculine, such as homo (man), rex (king) and Willelmus (William). Many other nouns are also masculine, including panis (bread) and solidus (shilling).</p>
            </li>
            <li>
                <h3 id="mass">Mass</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="oath of supremacy">Oath of Supremacy</h3>
                <hr>
            ...
            <li>
                <h3 id="official language">Official language</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="parochial">Parochial</h3>
                <hr>
                <p>Of or belonging to a parish.</p>
            </li>
            <li>
                <h3 id="parson">Parson</h3>
                <hr>
            ...
            <li>
                <h3 id="patent roll">Patent roll</h3>
                <hr>
            ...
            <li>
                ...
                <hr>
                <p>Amount of money and a coin. There were 12 pennies in one shilling. A penny was often represented by a ‘d’, short for denarius.</p>
            </li>
            <li>
            ...
            <li>
                <h3 id="personal pronoun">Personal pronoun</h3>
                <hr>
            ...
            <li>
                <h3 id="preposition">Preposition</h3>
                <hr>
            ...
            <li>
                <h3 id="principal parts">Principal parts</h3>
                <hr>
                <p>The parts of a verb listed in a Latin dictionary. Usually there are four parts, although only three are given for some verbs. The parts are always arranged in this order: the ‘I’ form of the present tense; the infinitive; the ‘I’ form of the past tense and the supine (not covered in this tutorial).
                    For example, dare to give:</p>
                <table class="table">
                    <tr>
                        <th></th>
                        <th>do , dare, dedi, datum (1)</th>
                        <th></th>
                        <th>to give</th>
                    ...
                    <tr>
                        ...
                        <td>1, 2, 3 or 4
                            Not given in every dictionary</td>
                    </tr>
                    <tr>
                        <td>Part one<br></td>
                        <td>Part two</td>
            ...
            <li>
                <h3 id="prove, proved">Prove, proved</h3>
                <hr>
        ...
        <ul>
            <li>
                <h3 id="reformation">Reformation</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="seek, seeks">Seek, seeks</h3>
                <hr>
            ...
            <li>
                <h3 id="shilling">Shilling</h3>
                <hr>
                <p>Amount of money and coin worth 12 pennies. There were twenty shillings in a pound. A shilling was represented by 's', short for solidus.</p>
            </li>
            <li>
                <h3 id="shipwright">Shipwright</h3>
                <hr>
            ...
            <li>
                <h3 id="state papers">State papers</h3>
                <hr>
        ...
        <ul>
            <li>
                <h3 id="tenant-in-chief">Tenant-in-chief</h3>
                <hr>
            ...
            <li>
                <h3 id="thane">Thane</h3>
                <hr>
                <p>Man who held lands from another, often the king, in England in the period before 1066.</p>
            </li>
            <li>
                <h3 id="thomas the martyr, thomas becket">Thomas the Martyr, Thomas Becket</h3>
                <hr>
        ...
        <ul>
            ...
            <li>
                <h3 id="westminster">Westminster</h3>
                <hr>
            ...
            <li>
                <h3 id="whalley">Whalley</h3>
                <hr>
                <p>Settlement in Lancashire.</p>
            </li>
            <li>
                <h3 id="william I, william the conqueror, duke william of normandy">William I, William the Conqueror, Duke William of Normandy</h3>
                <hr>
            ...
            <li>
                <h3 id="william caxton">William Caxton</h3>
                <hr>
            ...
            <li>
                <h3 id="witness, witnesses">Witness, witnesses</h3>
                <hr>
